  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Article.family() instead.
        "prototype$__get__family": {
          url: urlBase + "/Articles/:id/family",
          method: "GET"
        },

        // INTERNAL. Use Article.provider() instead.
        "prototype$__get__provider": {
          url: urlBase + "/Articles/:id/provider",
          method: "GET"
        },
    ...
    */
    R.modelName = "Article";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Article#family
         * @methodOf lbServices.Article
         *
         * @description
         *
         * Fetches belongsTo relation family.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         */
        R.family = function() {
          var TargetResource = $injector.get("Family");
          var action = TargetResource["::get::Article::family"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Article#provider
         * @methodOf lbServices.Article
         *
         * @description
         *
        ...
        R.provider = function() {
          ...
          var action = TargetResource["::get::Article::provider"];
          return action.apply(R, arguments);
        };
